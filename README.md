...
echo "<result>$AUDIT_LIST_NEAT</result>"
...
Before I go I'd like to thank Stephen Corbiaux for field testing an early version of this HOWTO and Allen Golbig for correcting some errors in setup.
